...
horas=segundosdias/SEGUNDOS_POR_HORA
segundoshora=segundosdias%SEGUNDOS_POR_HORA

minutos=segundoshora/SEGUNDOS_POR_MINUTO
segundosminutos=segundoshora%SEGUNDOS_POR_MINUTO
